...
add_action( 'init', 'register_adv_types' );

function register_adv_types(){

	register_post_type( 'adv', [
		'label'  => null,
		'labels' => [
			'name'               => 'adv', // основное название для типа записи
			'singular_name'      => 'adv', // название для одной записи этого типа
			...
			'not_found_in_trash' => 'Не найдено в корзине', // если не было найдено в корзине
			'parent_item_colon'  => '', // для родителей (у древовидных типов)
			'menu_name'          => 'Предложения для рекламодателей', // название меню
		],
		'description'            => '',
		'public'                 => true,
		// 'publicly_queryable'  => null, // зависит от public
